...
export default function AdminSignIn() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-accent to-secondary p-4">
      ...
      <Card className="w-full max-w-md animate-fade-in shadow-lg border-primary/20">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-2xl font-bold">NMIMS Grievance Portal</CardTitle>
          <CardDescription>Main Admin Sign In</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm space-y-2">
            <div>
              <Link to="/auth/teacher/sign-in" className="text-muted-foreground hover:text-primary">
                Sign in as Teacher/Dept Admin
              </Link>
            </div>
            <div>
              <Link to="/auth/student/sign-in" className="text-muted-foreground hover:text-primary">
                Sign in as Student
              </Link>
            </div>
          </div>
